...
public class FuncionesServicio {
	...
	public Funciones actualizar(Funciones funcionesActualizar) {
		...
		Funciones funcionesActualizado = repositorio.save(funcionActual); // actualizo la información en base datos
	...
	public void actualizar(int id, Funciones funcion) {
		...
		funcionActual.setPelicula(funcion.getPelicula());
		funcionActual.setPrecio(funcion.getPrecio());
		funcionActual.setSala(funcion.getSala());
		repositorio.save(funcionActual); // actualizo la información en base datos
